...
>
> 另外难点就是 mock，在较复杂功能的测试时，难点就是 mock 了。这时候写单元测试可能就会变成累赘，所以之前的工作中也就没有很好地贯彻下来。
>
> 不过在  纯逻辑功能函数中，使用单元测试会是非常棒的。建议在这种情况下，可以体验一下。
...
```js
jsUtils.isEmpty(WebInformation.minLimit);
```
